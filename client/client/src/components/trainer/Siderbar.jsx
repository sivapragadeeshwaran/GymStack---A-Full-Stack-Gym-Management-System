...
import { User, Calendar, LogOut, Menu, MessageCircle, X } from "lucide-react";
...
export default function TrainerSidebar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 w-full h-14 bg-[#141414] text-white flex items-center justify-between px-4 z-50 shadow-md">
